...
const Segment = class {
  constructor(hostRef) {
    ...
    this.ionSelect = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionSelect", 7);
...
const SegmentButton = class {
  ...
  connectedCallback() {
    ...
    if (segmentEl) {
      this.updateState();
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.f)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.f)(segmentEl, 'ionStyle', this.updateStyle);
    }
    // Prevent buttons from being disabled when associated with segment content
    if (this.contentId && this.disabled) {
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-segment-button] - Segment buttons cannot be disabled when associated with an <ion-segment-content>.`);
      this.disabled = false;
    }
  }
  disconnectedCallback() {
    ...
    if (segmentEl) {
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.m)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.m)(segmentEl, 'ionStyle', this.updateStyle);
      this.segmentEl = null;
    }
  }
  componentWillLoad() {
    this.inheritedAttributes = Object.assign({}, (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.el, ['aria-label']));
    ...
    if (!segmentContent) {
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.j)(`[ion-segment-button] - Unable to find Segment Content with id="${this.contentId}".`);
      return;
    }
    // Ensure the found element is a valid ION-SEGMENT-CONTENT
    if (segmentContent.tagName !== 'ION-SEGMENT-CONTENT') {
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.j)(`[ion-segment-button] - Element with id="${this.contentId}" is not an <ion-segment-content> element.`);
      return;
    }
  }
  get hasLabel() {
  ...
  render() {
    ...
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      ...
      part: "native",
      disabled: disabled
    }, this.inheritedAttributes), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("span", {
