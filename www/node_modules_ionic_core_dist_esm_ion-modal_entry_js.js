...
/* harmony import */ var _index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-Bs3kT4bc.js */ 6995);
/* harmony import */ var _framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-BYawdMXj.js */ 5311);
/* harmony import */ var _helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-DEn3pfjm.js */ 6341);
...
/* harmony import */ var _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-D5YkFThA.js */ 9402);
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 247);
/* harmony import */ var _index_r2D9DEro_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-r2D9DEro.js */ 6710);
/* harmony import */ var _ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ionic-global-CDrldh-5.js */ 7854);
/* harmony import */ var _keyboard_ywgs5efA_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./keyboard-ywgs5efA.js */ 4753);
/* harmony import */ var _animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./animation-Dt8bGnA-.js */ 5846);
/* harmony import */ var _cubic_bezier_hHmYLOfE_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cubic-bezier-hHmYLOfE.js */ 239);
/* harmony import */ var _index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./index-CfgBF1SE.js */ 5860);
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 575);
/* harmony import */ var _hardware_back_button_CPLxO_Ev_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./hardware-back-button-CPLxO-Ev.js */ 3538);
/* harmony import */ var _gesture_controller_BTEOs1at_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./gesture-controller-BTEOs1at.js */ 566);
/* harmony import */ var _keyboard_CUw4ekVy_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./keyboard-CUw4ekVy.js */ 2954);
...
const setCardStatusBarDark = () => {
  if (!_index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w || _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w.innerWidth >= 768) {
    return;
  }
  StatusBar.setStyle({
    style: Style.Dark
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
     ...
     */
    const shouldDismiss = yield el.canDismiss(undefined, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.G);
    if (!shouldDismiss) {
      return;
    }
    /**
...
const createSwipeToCloseGesture = (el, animation, statusBarStyle, onDismiss) => {
  ...
  let lastStep = 0;
  const getScrollY = () => {
    if (contentEl && (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
  ...
  const canStart = detail => {
     ...
     */
    contentEl = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.f)(target);
    if (contentEl) {
      /**
       ...
       * asynchronous.
       */
      if ((0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
        const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl);
  ...
  const onStart = detail => {
    ...
    if (deltaY > 0 && contentEl) {
      (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
  ...
  const onMove = detail => {
    ...
    const clampedStep = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
  ...
  const onEnd = detail => {
    ...
    if (!shouldComplete) {
      ...
      newStepValue += (0,_cubic_bezier_hHmYLOfE_js__WEBPACK_IMPORTED_MODULE_13__.g)([0, 0], [1, 0], [0.68, 0.28], [1, 1], clampedStep)[0];
    } else {
      animation.easing('cubic-bezier(0.32, 0.72, 0, 1)');
      newStepValue += (0,_cubic_bezier_hHmYLOfE_js__WEBPACK_IMPORTED_MODULE_13__.g)([0, 0], [0.32, 0.72], [0, 1], [1, 1], clampedStep)[0];
    }
    const duration = shouldComplete ? computeDuration(step * height, velocity) : computeDuration((1 - clampedStep) * height, velocity);
    isOpen = shouldComplete;
    gesture.enable(false);
    if (contentEl) {
      (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialScrollY);
    }
    animation.onFinish(() => {
      if (!shouldComplete) {
        gesture.enable(true);
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_14__.createGesture)({
    el,
    gestureName: 'modalSwipeToClose',
    gesturePriority: _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.O,
    direction: 'y',
    threshold: 10,
    canStart,
    onStart,
...
const computeDuration = (remaining, velocity) => {
  return (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.e)(400, remaining / Math.abs(velocity * 1.1), 500);
};
const createSheetEnterAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
  if (shouldShowBackdrop) {
    backdropAnimation.beforeStyles({
      'pointer-events': 'none'
    }).afterClearStyles(['pointer-events']);
  }
  const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
   ...
   */
  const contentAnimation = !expandToScroll ? (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('contentAnimation').keyframes([{
    offset: 0,
    opacity: 1,
...
const createSheetLeaveAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
  const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
    transform: `translateY(${100 - currentBreakpoint * 100}%)`
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  return {
    backdropAnimation,
    wrapperAnimation,
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
  const {
    wrapperAnimation,
    backdropAnimation,
    contentAnimation
  ...
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation([wrapperAnimation]);
  if (contentAnimation) {
  ...
  if (presentingEl) {
    ...
    const presentingElRoot = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    ...
    if (isPortrait) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().afterStyles({
          transform: finalTransform
...
const createLeaveAnimation$1 = () => {
  const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
  const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);
  if (presentingEl) {
    const isPortrait = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isPortrait) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          transform: 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const portraitToLandscapeTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingEl) {
    ...
    return (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('portrait-to-landscape-transition');
  }
  const presentingElIsCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
  const presentingElRoot = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
  const bodyEl = document.body;
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('portrait-to-landscape-transition').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration);
  const presentingAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    transform: 'translateY(0)',
    'transform-origin': 'top center',
    overflow: 'hidden'
  ...
  if (!presentingElIsCardModal) {
    ...
    const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
    const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelectorAll('.modal-wrapper, .modal-shadow')).fromTo('opacity', '1', '1'); // Keep wrapper visible in landscape
    const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 'var(--backdrop-opacity)'); // Keep backdrop visible
...
const landscapeToPortraitTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingEl) {
    // No transition needed for non-card modals
    return (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('landscape-to-portrait-transition');
  }
  const presentingElIsCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
  const presentingElRoot = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
  const bodyEl = document.body;
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)('landscape-to-portrait-transition').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration);
  const presentingAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    transform: 'translateY(0)',
    'transform-origin': 'top center',
    overflow: 'hidden'
  ...
  if (!presentingElIsCardModal) {
    ...
    // need to care about layering and modal-specific styles.
    const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
    const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelectorAll('.modal-wrapper, .modal-shadow')).fromTo('opacity', '1', '1'); // Keep wrapper visible
    const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 'var(--backdrop-opacity)'); // Keep backdrop visible
...
const createEnterAnimation = () => {
  ...
  const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().keyframes([{
    offset: 0,
    opacity: 0.01,
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  // all the breakpoints.
  !expandToScroll && (contentAnimation === null || contentAnimation === void 0 ? void 0 : contentAnimation.addElement(baseEl.querySelector('.ion-page')));
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
  if (contentAnimation) {
    baseAnimation.addAnimation(contentAnimation);
  }
  return baseAnimation;
...
const mdLeaveAnimation = (baseEl, opts) => {
  ...
  backdropAnimation.addElement(root.querySelector('ion-backdrop'));
  wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_12__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
  return baseAnimation;
};
const createSheetGesture = (baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], expandToScroll, getCurrentBreakpoint, onDismiss, onBreakpointChange) => {
  ...
  const enableBackdrop = () => {
     ...
     * the sheet.
     */
    baseEl.classList.remove(_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  const disableBackdrop = () => {
     ...
     */
    baseEl.classList.add(_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  /**
  ...
  const canStart = detail => {
     ...
     */
    const contentEl = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
    ...
    if (!expandToScroll && contentEl) {
      const scrollEl = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl) ? (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl).querySelector('.inner-scroll') : contentEl;
  ...
  const onStart = detail => {
     ...
     */
    if (!expandToScroll) {
      const targetEl = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
      cachedScrollEl = targetEl && (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.i)(targetEl) ? (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(targetEl).querySelector('.inner-scroll') : targetEl;
    }
    /**
    ...
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
      /**
  ...
  const onMove = detail => {
    ...
    offset = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalDidPresent", 7);
    this.willPresent = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalWillPresent", 7);
    this.willDismiss = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalWillDismiss", 7);
    this.didDismiss = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalDidDismiss", 7);
    this.ionBreakpointDidChange = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionBreakpointDidChange", 7);
    ...
    this.ionMount = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionMount", 7);
    this.lockController = (0,_lock_controller_B_hirT0v_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    this.triggerController = (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.e)();
    this.coreDelegate = (0,_framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_3__.C)();
    ...
    this.onBackdropTap = () => {
      ...
      this.dismiss(undefined, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.B);
    };
  ...
  onWindowResize() {
    ...
    if ((0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios' || !this.presentingElement || this.enterAnimation || this.leaveAnimation) {
      return;
    }
  ...
  connectedCallback() {
    ...
    (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.j)(el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.b)(el, attributesToInherit);
    ...
    if (breakpoints !== undefined && initialBreakpoint !== undefined && !breakpoints.includes(initialBreakpoint)) {
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-modal] - Your breakpoints array must include the initialBreakpoint value.');
    }
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
     ...
     */
    if (this.isOpen === true) {
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => this.present());
    }
  ...
  present() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['ion-page'], _this2.componentProps, inline);
      /**
       ...
       */
      if ((0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.h)(el)) {
        yield (0,_index_r2D9DEro_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_r2D9DEro_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this2.el.classList.add('show-modal'));
       ...
       */
      if (hasCardModal && (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_10__.b)(_this2) === 'ios') {
        // Cache the original status bar color before the modal is presented
        _this2.statusBarStyle = yield StatusBar.getStyle();
        setCardStatusBarDark();
      }
      yield (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (typeof window !== 'undefined') {
        ...
        window.addEventListener(_keyboard_ywgs5efA_js__WEBPACK_IMPORTED_MODULE_11__.KEYBOARD_DID_OPEN, _this2.keyboardOpenCallback);
      }
      /**
       * Recalculate isSheetModal because framework bindings (e.g., Angular)
       * may not have been applied when componentWillLoad ran.
       */
      const isSheetModal = _this2.breakpoints !== undefined && _this2.initialBreakpoint !== undefined;
      _this2.isSheetModal = isSheetModal;
      if (isSheetModal) {
      ...
      _this2.initViewTransitionListener();
      // Initialize parent removal observer
      _this2.initParentRemovalObserver();
      unlock();
    })();
  }
  initSwipeToClose() {
    var _this3 = this;
    var _a;
    if ((0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios') {
      return;
    }
    const {
      el
    ...
    const animationBuilder = this.leaveAnimation || _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('modalLeave', iosLeaveAnimation);
    const ani = this.animation = animationBuilder(el, {
      presentingEl: this.presentingElement,
      expandToScroll: this.expandToScroll
    });
    const contentEl = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.a)(el);
    if (!contentEl) {
      (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.p)(el);
      return;
    }
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, statusBarStyle, () => {
      ...
      this.animation.onFinish(/*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield _this3.dismiss(undefined, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  initSheetGesture() {
    ...
    const animationBuilder = this.enterAnimation || _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('modalEnter', iosEnterAnimation);
  ...
  setupChildRoutePassthrough() {
    ...
    const hasVisibleContent = Array.from(pageParent.children).some(child => {
      var _a;
      return child !== this.el && !(child instanceof HTMLElement && window.getComputedStyle(child).display === 'none') && child.tagName !== 'TEMPLATE' && child.tagName !== 'SLOT' && !(child.nodeType === Node.TEXT_NODE && !((_a = child.textContent) === null || _a === void 0 ? void 0 : _a.trim()));
    });
  ...
  sheetOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this4.dismiss(undefined, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  dismiss(data, role) {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
      if (_this5.gestureAnimationDismissing && role !== _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.G) {
        return false;
      }
      /**
       ...
       */
      yield _this5.dismissNestedModals();
      /**
       ...
       */
      const hasCardModal = presentingElement !== undefined;
      if (hasCardModal && (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_10__.b)(_this5) === 'ios') {
        setCardStatusBarDefault(_this5.statusBarStyle);
      }
      /* tslint:disable-next-line */
      if (typeof window !== 'undefined' && _this5.keyboardOpenCallback) {
        window.removeEventListener(_keyboard_ywgs5efA_js__WEBPACK_IMPORTED_MODULE_11__.KEYBOARD_DID_OPEN, _this5.keyboardOpenCallback);
        _this5.keyboardOpenCallback = undefined;
      }
      const dismissed = yield (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.g)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
        presentingEl: presentingElement,
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this5.usersElement);
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this5.el.classList.remove('show-modal'));
        if (_this5.animation) {
        ...
        _this5.cleanupViewTransitionListener();
        _this5.cleanupParentRemovalObserver();
        _this5.cleanupChildRoutePassthrough();
      }
   ...
   */
  onDidDismiss() {
    return (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalDidDismiss');
  }
  /**
   * Returns a promise that resolves when the modal will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalWillDismiss');
  }
  /**
  ...
  setCurrentBreakpoint(breakpoint) {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this6.isSheetModal) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-modal] - setCurrentBreakpoint is only supported on sheet modals.');
        return;
      }
      if (!_this6.breakpoints.includes(breakpoint)) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-modal] - Attempted to set invalid breakpoint value ${breakpoint}. Please double check that the breakpoint value is part of your defined breakpoints.`);
        return;
      }
      const {
        currentBreakpoint,
  ...
  reinitSwipeToClose() {
    ...
    if ((0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios' || !this.presentingElement) {
      return;
    }
  ...
  ensureCorrectModalPosition() {
    ...
    const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(el);
  ...
  dismissNestedModals() {
    var _this9 = this;
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const nestedModals = document.querySelectorAll(`ion-modal[data-parent-ion-modal="${_this9.el.id}"]`);
      nestedModals === null || nestedModals === void 0 ? void 0 : nestedModals.forEach(/*#__PURE__*/function () {
        var _ref5 = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (modal) {
          yield modal.dismiss(undefined, 'parent-dismissed');
        });
        return function (_x3) {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_10__.b)(this);
    ...
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign({
        ...
        'overlay-hidden': true,
        [_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_7__.F]: focusTrap === false
      ...
      part: "backdrop"
    }), mode === 'ios' && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'bffd69b4635c22d9f249725bd952c1e93d5615c7',
      class: "modal-shadow"
    }), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", Object.assign({
    ...
    }), showHandle && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
