...
const PickerColumn = class {
  constructor(hostRef) {
    ...
    this.onKeyDown = ev => {
       ...
       */
      const mobile = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_5__.a)('mobile');
      let newOption = null;
      switch (ev.key) {
        case 'ArrowDown':
  ...
  componentWillLoad() {
    ...
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector(`.${PICKER_ITEM_ACTIVE_CLASS}`);
        if (oldActive) {
  ...
  scrollActiveItemIntoView() {
    var _this = this;
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (smooth = false) {
  ...
  render() {
    ...
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      ...
      class: (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_6__.c)(color, {
        [mode]: true,
