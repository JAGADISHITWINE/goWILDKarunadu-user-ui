...
/* harmony import */ var _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overlays-D5YkFThA.js */ 9402);
...
/* harmony import */ var _index_r2D9DEro_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-r2D9DEro.js */ 6710);
/* harmony import */ var _animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./animation-Dt8bGnA-.js */ 5846);
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 575);
/* harmony import */ var _hardware_back_button_CPLxO_Ev_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./hardware-back-button-CPLxO-Ev.js */ 3538);
...
const configureDismissInteraction = (triggerEl, triggerAction, popoverEl, parentPopoverEl) => {
  ...
  const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(parentPopoverEl);
  ...
  switch (triggerAction) {
    case 'hover':
      ...
      triggerCallbacks = [{
        eventName: 'mouseenter',
        callback: function () {
          var _ref = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
            ev.stopPropagation();
            if (hoverTimeout) {
...
const focusItem = item => {
  const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.g)(item);
  const button = root.querySelector('button');
  if (button) {
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => button.focus());
  }
};
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const contentAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const backdropAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const contentAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  const viewportAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_9__.c)();
  backdropAnimation.addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverDidPresent", 7);
    this.willPresent = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverWillPresent", 7);
    this.willDismiss = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverWillDismiss", 7);
    this.didDismiss = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionPopoverDidDismiss", 7);
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.B);
    };
    ...
    this.configureTriggerInteraction = () => {
      ...
      if (!triggerEl) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-popover] - A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-popover.`, this.el);
        return;
      }
  ...
  connectedCallback() {
    ...
    (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.j)(el);
    configureTriggerInteraction();
  }
  ...
  componentWillLoad() {
    ...
    const popoverId = (_b = (_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.k)(el);
    this.parentPopover = el.closest(`ion-popover:not(#${popoverId})`);
    if (this.alignment === undefined) {
      this.alignment = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_6__.b)(this) === 'ios' ? 'center' : 'start';
    }
  }
  componentDidLoad() {
    const {
    ...
    if (parentPopover) {
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.f)(parentPopover, 'ionPopoverWillDismiss', () => {
  ...
  presentFromTrigger(_x3) {
    var _this = this;
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (event, focusDescendant = false) {
  ...
  present(event) {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['popover-viewport'], _this2.componentProps, inline);
      _this2.recalculateContentOnHeaderReady();
      ...
      if ((0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_4__.h)(el)) {
        yield (0,_index_r2D9DEro_js__WEBPACK_IMPORTED_MODULE_8__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_r2D9DEro_js__WEBPACK_IMPORTED_MODULE_8__.w)();
      }
      yield (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.n)(el);
      }
      unlock();
    })();
  }
  ...
  recalculateContentOnHeaderReady() {
    ...
    this.headerResizeObserver = new ResizeObserver(/*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
      if (header.offsetHeight > 0) {
        (_a = _this3.headerResizeObserver) === null || _a === void 0 ? void 0 : _a.disconnect();
        _this3.headerResizeObserver = undefined;
  ...
  dismiss(_x4, _x5) {
    var _this4 = this;
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (data, role, dismissParentPopover = true) {
      const unlock = yield _this4.lockController.lock();
      const {
        destroyKeyboardInteraction,
        destroyDismissInteraction
      } = _this4;
      if (dismissParentPopover && _this4.parentPopover) {
        _this4.parentPopover.dismiss(data, role, dismissParentPopover);
      }
      const shouldDismiss = yield (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.g)(_this4, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this4.event);
      if (shouldDismiss) {
        if (destroyKeyboardInteraction) {
          destroyKeyboardInteraction();
          _this4.destroyKeyboardInteraction = undefined;
        }
        if (destroyDismissInteraction) {
          destroyDismissInteraction();
          _this4.destroyDismissInteraction = undefined;
        }
        /**
        ...
        yield (0,_framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this4.usersElement);
      }
      unlock();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.el, 'ionPopoverWillDismiss');
  }
  render() {
    ...
    const desktop = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_6__.a)('desktop');
    ...
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      key: '42863f748c93f709d433931d969230137b37d42d',
      "aria-modal": "true",
      "no-router": true,
      tabindex: "-1"
    }, htmlAttributes, {
      ...
      class: Object.assign(Object.assign({}, (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.cssClass)), {
        ...
        [_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_2__.F]: focusTrap === false,
    ...
    }), !parentPopover && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-backdrop", {
      key: '22b6d82178b52158b76ab3fd9a7dd738fd6e4bbf',
      tappable: this.backdropDismiss,
      visible: this.showBackdrop,
      part: "backdrop"
    }), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'b76335c64e992a964ed3fb91d17a992c3474b4cd',
      class: "popover-wrapper ion-overlay-wrapper",
      onClick: dismissOnSelect ? () => this.dismiss() : undefined
    }, enableArrow && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '018c846c32e7ff7fa010528e6b37a17e5f03c84c',
      class: "popover-arrow",
      part: "arrow"
    }), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '350c468c80052da3a07768bceab98fe159c35a43',
      class: "popover-content",
      part: "content"
    }, (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: '686443c17ac9873d33905c1cdb67e6d6da675282'
    }))));
  }
  get el() {
