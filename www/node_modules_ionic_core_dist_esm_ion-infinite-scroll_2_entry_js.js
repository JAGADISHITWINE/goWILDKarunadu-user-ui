...
/* harmony import */ var _config_mCdtaoPe_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./config-mCdtaoPe.js */ 3550);
...
const InfiniteScroll = class {
  constructor(hostRef) {
    ...
    this.ionInfinite = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionInfinite", 7);
    this.thrPx = 0;
    this.thrPc = 0;
    /**
  ...
  connectedCallback() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const contentEl = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.f)(_this.el);
      if (!contentEl) {
        (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.p)(_this.el);
        return;
      }
      _this.scrollEl = yield (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.g)(contentEl);
...
const InfiniteScrollContent = class {
  constructor(hostRef) {
    (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.customHTMLEnabled = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('innerHTMLTemplatesEnabled', _config_mCdtaoPe_js__WEBPACK_IMPORTED_MODULE_4__.E);
  }
  componentDidLoad() {
    if (this.loadingSpinner === undefined) {
      const mode = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_3__.b)(this);
      this.loadingSpinner = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('infiniteLoadingSpinner', _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('spinner', mode === 'ios' ? 'lines' : 'crescent'));
    }
  }
  renderLoadingText() {
    const {
    ...
    if (customHTMLEnabled) {
      return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
        ...
        innerHTML: (0,_config_mCdtaoPe_js__WEBPACK_IMPORTED_MODULE_4__.a)(loadingText)
      });
    }
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "infinite-loading-text"
  ...
  render() {
    ...
    }, this.loadingSpinner && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
