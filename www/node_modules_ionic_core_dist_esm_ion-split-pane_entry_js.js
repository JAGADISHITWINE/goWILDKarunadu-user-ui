...
const SplitPane = class {
  constructor(hostRef) {
    ...
    this.ionSplitPaneVisible = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionSplitPaneVisible", 7);
    this.visible = false;
    /**
  ...
  styleMainElement() {
    ...
    for (let i = 0; i < nu; i++) {
      ...
      if (isMain) {
        if (foundMain) {
          (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-split-pane] - Cannot have more than one main node.');
          return;
        } else {
    ...
    if (!foundMain) {
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-split-pane] - Does not have a specified main node.');
    }
  }
  render() {
