...
class MediaService {
  constructor() {
    this.imageBaseUrl = (src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.mediaBaseUrl || '').replace(/\/?$/, '/');
  ...
  resolve(src, cacheKey) {
    ...
    let resolved;
    if (/^(https?:)?\/\//i.test(value)) resolved = value;else if (value.startsWith('data:') || value.startsWith('blob:')) resolved = value;else resolved = `${this.imageBaseUrl}${value.replace(/^\/+/, '')}`;
    const key = String(cacheKey || '').trim();
    if (!key) return resolved;
    return resolved.includes('?') ? `${resolved}&v=${encodeURIComponent(key)}` : `${resolved}?v=${encodeURIComponent(key)}`;
  }
  static #_ = _staticBlock = () => (this.ɵfac = function MediaService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || MediaService)();
...
/***/ 2440
/*!*************************************************!*\
  !*** ./src/app/core/public-route-id.service.ts ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   PublicRouteIdService: () => (/* binding */ PublicRouteIdService)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 4205);
var _staticBlock;

class PublicRouteIdService {
  constructor() {
    this.prefix = 'trk:';
    this.opaqueRefPattern = /^[A-Za-z0-9_-]{40,}$/;
  }
  isOpaqueRef(value) {
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function PublicRouteIdService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || PublicRouteIdService)();
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    token: PublicRouteIdService,
    factory: PublicRouteIdService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
/***/ 3046
/*!*************************************************!*\
  !*** ./src/app/core/trek-operations.service.ts ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TrekOperationsService: () => (/* binding */ TrekOperationsService)
/* harmony export */ });
...
class TrekOperationsService {
  constructor(http) {
    this.http = http;
    this.API = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__.environment.baseUrl;
  }
  getWallet(userId) {
    const url = userId ? `${this.API}/wallet/${userId}` : `${this.API}/wallet`;
    return this.http.get(url).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(res => res?.data || {
      balance: 0,
      bonusBalance: 0,
  ...
  getTaxInvoice(bookingId) {
    return this.http.get(`${this.API}/bookings/${bookingId}/tax-invoice`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(res => res?.data || null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_0__.of)(null)));
  }
  getSummitCertificate(bookingId) {
    return this.http.get(`${this.API}/bookings/${bookingId}/summit-certificate`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(res => res?.data || null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_0__.of)(null)));
  }
  payRemainder(bookingId, payload) {
    return this.http.post(`${this.API}/bookings/${bookingId}/pay-remainder`, payload);
  }
  getCarpools(filter) {
    let params = {};
    if (filter?.departureCity) params.departureCity = filter.departureCity;
    if (filter?.trekName) params.trekName = filter.trekName;
    return this.http.get(`${this.API}/community/carpools`, {
      params
    }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(res => res?.data || []), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_0__.of)([])));
  }
  createCarpoolOffer(ride) {
    return this.http.post(`${this.API}/community/carpools`, ride);
  }
  static #_ = _staticBlock = () => (this.ɵfac = function TrekOperationsService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || TrekOperationsService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClient));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
    token: TrekOperationsService,
    factory: TrekOperationsService.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TourDetails: () => (/* binding */ TourDetails)
/* harmony export */ });
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/environments/environment */ 5312);
...
class TourDetails {
  constructor(http, crypto) {
    this.http = http;
    this.crypto = crypto;
    this.API = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.baseUrl}`;
  }
  getTrekById(trekId) {
    return this.http.get(`${this.API}/getTrekByUuid/${trekId}`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.map)(res => {
  ...
  getTrekByUuid(uuid) {
    return this.http.get(`${this.API}/getTrekByUuid/${uuid}`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.map)(res => {
      const decrypted = this.crypto.decrypt(res.data);
      return {
        ...res,
        data: decrypted
  ...
  getAllTreks() {
    return this.http.get(`${this.API}/getAllTreks`).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_1__.map)(res => {
      const decrypted = this.crypto.decrypt(res.data);
      return {
        ...res,
        data: decrypted
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function TourDetails_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || TourDetails)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_core_encryption_service__WEBPACK_IMPORTED_MODULE_4__.EncryptionService));
  }, this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
    token: TourDetails,
    factory: TourDetails.ɵfac,
    providedIn: 'root'
  }));
}
_staticBlock();
...
/* harmony export */ });
/* harmony import */ var _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-C8IsBmNU.js */ 6922);
...
const createButtonActiveGesture = (el, isButton) => {
  ...
  const setActiveButton = (button, hapticFeedbackFn) => {
    ...
    (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => buttonToModify.classList.add('ion-activated'));
    hapticFeedbackFn();
  };
  const clearActiveButton = (dispatchClick = false) => {
    ...
    const buttonToModify = currentTouchedButton;
    (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => buttonToModify.classList.remove('ion-activated'));
    /**
...
/* harmony import */ var _helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers-DEn3pfjm.js */ 6341);
/* harmony import */ var _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-C8IsBmNU.js */ 6922);
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const printIonContentErrorMsg = el => {
  return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_2__.t)(el, ION_CONTENT_ELEMENT_SELECTOR);
};
/**
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
    ...
    const init = /*#__PURE__*/function () {
      var _ref2 = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
const createLockController = () => {
  ...
  const lock = /*#__PURE__*/function () {
    var _ref = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const p = waitPromise;
      let resolve;
...
/* harmony export */ });
/* harmony import */ var _helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers-DEn3pfjm.js */ 6341);
/* harmony import */ var _dir_C53feagD_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dir-C53feagD.js */ 1008);
/* harmony import */ var _index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-CfgBF1SE.js */ 5860);
/* harmony import */ var _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-C8IsBmNU.js */ 6922);
...
const createSwipeBackGesture = (el, canStartHandler, onStartHandler, onMoveHandler, onEndHandler) => {
  ...
  const onEnd = detail => {
    ...
    onEndHandler(shouldComplete, stepValue <= 0 ? 0.01 : (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_0__.e)(0, stepValue, 0.9999), realDur);
  };
  return (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_2__.createGesture)({
    el,
