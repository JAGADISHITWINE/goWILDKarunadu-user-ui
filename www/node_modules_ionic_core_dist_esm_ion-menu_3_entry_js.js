...
/* harmony import */ var _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-D5YkFThA.js */ 9402);
...
/* harmony import */ var _hardware_back_button_CPLxO_Ev_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hardware-back-button-CPLxO-Ev.js */ 3538);
/* harmony import */ var _helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers-DEn3pfjm.js */ 6341);
/* harmony import */ var _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-CvDIirVx.js */ 8670);
...
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 247);
...
/* harmony import */ var _animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./animation-Dt8bGnA-.js */ 5846);
...
const Menu = class {
  constructor(hostRef) {
    ...
    this.ionWillOpen = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionWillOpen", 7);
    this.ionWillClose = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionWillClose", 7);
    this.ionDidOpen = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDidOpen", 7);
    this.ionDidClose = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDidClose", 7);
    this.ionMenuChange = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionMenuChange", 7);
    this.lastOnEnd = 0;
    ...
    this.handleFocus = ev => {
       ...
       */
      const lastOverlay = (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__.o)(document);
  ...
  sideChanged() {
    this.isEndSide = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__.o)(this.side);
    /**
  ...
  connectedCallback() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (_this.type === undefined) {
        _this.type = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('menuType', 'overlay');
      }
      const content = _this.contentId !== undefined ? document.getElementById(_this.contentId) : null;
      if (content === null) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-menu] - Must have a "content" element to listen for drag events on.');
        return;
      }
      if (_this.el.contains(content)) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.j)(`[ion-menu] - The "contentId" should refer to the main view's ion-content, not the ion-content inside of the ion-menu.`);
      }
      ...
      _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m._register(_this);
      _this.menuChanged();
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el);
  }
  componentDidLoad() {
    var _this2 = this;
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  disconnectedCallback() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m._unregister(_this3);
      if (_this3.animation) {
  ...
  onBackdropClick(ev) {
    ...
    if (this._isOpen && this.lastOnEnd < ev.timeStamp - 100) {
      ...
      if (shouldClose) {
        ev.preventDefault();
        ev.stopPropagation();
        this.close(undefined, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__.B);
      }
    }
  }
  onKeydown(ev) {
  ...
  setOpen(shouldOpen, animated = true, role) {
    ...
    return _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m._setOpen(this, shouldOpen, animated, role);
  }
  trapKeyboardFocus(ev, doc) {
    ...
    if (this.el.contains(target)) {
       ...
       * here to avoid that.
       */
      (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__.n)(el);
      /**
      ...
      if (this.lastFocus === doc.activeElement) {
        (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__.q)(el);
      }
    }
  }
  _setOpen(_x) {
    var _this4 = this;
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (shouldOpen, animated = true, role) {
  ...
  loadAnimation() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
       ...
       * If the document direction changes, we need to create a new animation.
       */
      const isEndSide$1 = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__.o)(_this5.side);
      ...
      const animation = _this5.animation = yield _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m._createAnimation(_this5.type, _this5);
      if (!_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('animated', true)) {
  ...
  startAnimation(shouldOpen, animated) {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const mode = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_8__.b)(_this6);
  ...
  canStart(detail) {
    ...
    if (this._isOpen) {
      return true;
    } else if (_index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m._getOpenSync()) {
      return false;
    }
    return checkEdgeSide(window, detail.currentX, this.isEndSide, this.maxEdgeStart);
  }
  onWillStart() {
    this.beforeAnimation(!this._isOpen, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__.G);
    return this.loadAnimation();
  }
  onStart() {
    if (!this.isAnimating || !this.animation) {
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__.l)(false, 'isAnimating has to be true');
      return;
    }
  ...
  onEnd(detail) {
     ...
     */
    newStepValue += (0,_cubic_bezier_hHmYLOfE_js__WEBPACK_IMPORTED_MODULE_2__.g)([0, 0], [0.4, 0], [0.6, 1], [1, 1], (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__.e)(0, adjustedStepValue, 0.9999))[0] || 0;
    const playTo = this._isOpen ? !shouldComplete : shouldComplete;
    this.animation.easing('cubic-bezier(0.4, 0.0, 0.6, 1)').onFinish(() => this.afterAnimation(shouldOpen, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__.G), {
      oneTimeCallback: true
    }).progressEnd(playTo ? 1 : 0, this._isOpen ? 1 - newStepValue : newStepValue, 300);
  }
  beforeAnimation(shouldOpen, role) {
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__.l)(!this.isAnimating, '_before() should not be called while animating');
    /**
     ...
     */
    if ((0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_8__.a)('android')) {
  ...
  updateState() {
    ...
    if (!isActive) {
       ...
       */
      this.afterAnimation(false, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_3__.G);
    }
  }
  render() {
    const {
    ...
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      ...
      onKeyDown: (0,_hardware_back_button_CPLxO_Ev_js__WEBPACK_IMPORTED_MODULE_5__.shouldUseCloseWatcher)() ? null : this.onKeydown,
      role: "navigation",
...
const updateVisibility = /*#__PURE__*/function () {
  var _ref = (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (menu) {
    const menuEl = yield _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m.get(menu);
...
const MenuButton = class {
  constructor(hostRef) {
     ...
     */
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m.toggle(_this7.menu);
    });
  }
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el);
  ...
  render() {
    ...
    const mode = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_8__.b)(this);
    const menuIcon = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('menuIcon', mode === 'ios' ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_10__.u : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_10__.v);
    ...
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, {
    ...
    }, (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({
      ...
      lazy: false,
      "aria-hidden": "true"
    }))), mode === 'md' && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
...
const MenuToggle = class {
  constructor(hostRef) {
    ...
    this.autoHide = true;
    this.onClick = () => {
      return _index_CvDIirVx_js__WEBPACK_IMPORTED_MODULE_7__.m.toggle(this.menu);
    };
  }
  connectedCallback() {
    this.visibilityChanged();
