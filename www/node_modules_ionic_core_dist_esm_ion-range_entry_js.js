...
function getDecimalPlaces(n) {
  if (!(0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.j)(n)) return 0;
  if (n % 1 === 0) return 0;
...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionInput = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionInput", 7);
    ...
    this.ionKnobMoveStart = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionKnobMoveEnd", 7);
    ...
    this.clampBounds = value => {
      return (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.e)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
     ...
     */
    this.ionInput = debounce === undefined ? originalIonInput !== null && originalIonInput !== void 0 ? originalIonInput : ionInput : (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.d)(ionInput, debounce);
  }
  minChanged(newValue) {
    if (!(0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.j)(newValue)) {
      this.min = 0;
    }
    if (!this.noUpdate) {
      this.updateRatio();
  ...
  activeBarStartChanged() {
    ...
    if (activeBarStart !== undefined) {
      if (activeBarStart > this.max) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-range] - The value of activeBarStart (${activeBarStart}) is greater than the max (${this.max}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
        this.activeBarStart = this.max;
      } else if (activeBarStart < this.min) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-range] - The value of activeBarStart (${activeBarStart}) is less than the min (${this.min}). Valid values are greater than or equal to the min value and less than or equal to the max value.`, this.el);
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.i)(this.el);
    // If min, max, or step are not safe, set them to 0, 100, and 1, respectively.
    // Each watch does this, but not before the initial load.
    this.min = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.min) ? this.min : 0;
    this.max = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.max) ? this.max : 100;
    this.step = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.j)(this.step) ? this.step : 1;
  }
  componentDidLoad() {
  ...
  connectedCallback() {
    ...
    const ionContent = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.f)(this.el);
  ...
  onMove(detail) {
    ...
    if (contentEl && this.pressedKnob === undefined) {
      this.initialContentScrollY = (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
    /**
  ...
  onEnd(detail) {
     ...
     */
    if (contentEl && this.pressedKnob !== undefined) {
      (0,_index_Bs3kT4bc_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialContentScrollY);
    }
  ...
  update(currentX) {
    ...
    let ratio = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, (currentX - rect.left) / rect.width, 1);
  ...
  renderRangeSlider() {
    ...
    }, ticks.map(tick => (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.a)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      ...
      part: "label"
    }, label !== undefined ? (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "label-text"
    }, label) : (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "label"
    })), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      name: "start"
    }), this.renderRangeSlider(), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  const clampedValue = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.e)(min, value, max);
  return roundToMaxDecimalPlaces(clampedValue, min, max, step);
};
const valueToRatio = (value, min, max) => {
  return (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.e)(0, (value - min) / (max - min), 1);
};
let rangeIds = 0;
Range.style = {
  ios: rangeIosCss,
