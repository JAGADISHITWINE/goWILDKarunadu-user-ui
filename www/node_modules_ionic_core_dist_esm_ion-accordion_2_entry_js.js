...
/* harmony import */ var _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-DV3sJJW8.js */ 7594);
...
const Accordion = class {
  constructor(hostRef) {
     ...
     * or collapsed.
     */
    this.toggleIcon = _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_3__.l;
    /**
    ...
    this.setAria = (expanded = false) => {
       ...
       */
      const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.g)(ionItem);
    ...
    this.expandAccordion = () => {
      ...
      if (this.shouldAnimate()) {
        (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
          ...
          this.currentRaf = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.r)(/*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const contentHeight = contentElWrapper.offsetHeight;
            const waitForTransition = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
    ...
    this.collapseAccordion = () => {
      ...
      if (this.shouldAnimate()) {
        this.currentRaf = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.r)(/*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          ...
          contentEl.style.setProperty('max-height', `${contentHeight}px`);
          (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.r)(/*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
            const waitForTransition = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.t)(contentEl, 2000);
    ...
    this.shouldAnimate = () => {
      ...
      const animated = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('animated', true);
      if (!animated) {
        return false;
      }
    ...
    this.updateState = /*#__PURE__*/(0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  connectedCallback() {
    ...
    if (accordionGroupEl) {
      this.updateState();
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.f)(accordionGroupEl, 'ionValueChange', this.accordionGroupUpdateHandler);
    }
  }
  disconnectedCallback() {
    const accordionGroupEl = this.accordionGroupEl;
    if (accordionGroupEl) {
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.m)(accordionGroupEl, 'ionValueChange', this.accordionGroupUpdateHandler);
    }
  }
  componentDidLoad() {
    this.setItemDefaults();
...
const AccordionGroup = class {
  ...
  valueChanged() {
    ...
    if (!multiple && Array.isArray(value)) {
       ...
       * Custom behavior: ['a', 'b']
       */
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-accordion-group] - An array of values was passed, but multiple is "false". This is incorrect usage and may result in unexpected behaviors. To dismiss this warning, pass a string to the "value" property when multiple="false".
