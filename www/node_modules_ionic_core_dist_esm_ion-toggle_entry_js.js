...
/* harmony import */ var _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-DV3sJJW8.js */ 7594);
/* harmony import */ var _capacitor_CFERIeaU_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./capacitor-CFERIeaU.js */ 5051);
...
const Toggle = class {
  constructor(hostRef) {
     ...
     */
    this.enableOnOffLabels = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('toggleOnOffLabels');
    /**
    ...
    this.onClick = ev => {
       ...
       * only trigger on iOS.
       */
      const enableHaptics = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_5__.a)('ios');
      if (this.disabled) {
        return;
      }
      ev.preventDefault();
      if (this.lastDrag + 300 < Date.now()) {
        this.toggleChecked();
        enableHaptics && (0,_haptic_DzAMWJuk_js__WEBPACK_IMPORTED_MODULE_4__.c)();
      }
    };
    /**
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_8__.f : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_8__.r;
      }
      return checked ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_8__.r : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_8__.g;
    };
  }
  disabledChanged() {
    if (this.gesture) {
  ...
  connectedCallback() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (typeof MutationObserver !== 'undefined') {
        _this2.validationObserver = new MutationObserver(() => {
          const newIsInvalid = (0,_validity_DJztqcrH_js__WEBPACK_IMPORTED_MODULE_3__.c)(el);
          if (_this2.isInvalid !== newIsInvalid) {
            _this2.isInvalid = newIsInvalid;
            /**
            ...
            Promise.resolve().then(() => {
              _this2.hintTextId = _this2.getHintTextId();
            });
          }
        });
        _this2.validationObserver.observe(el, {
          attributes: true,
          attributeFilter: ['class']
        });
      }
      // Always set initial state
      _this2.isInvalid = (0,_validity_DJztqcrH_js__WEBPACK_IMPORTED_MODULE_3__.c)(el);
    })();
  }
  componentDidLoad() {
    this.setupGesture();
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign({}, (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el));
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_C53feagD_js__WEBPACK_IMPORTED_MODULE_6__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.toggleChecked();
      (0,_haptic_DzAMWJuk_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.a)(true, el, name, checked ? value : '', disabled);
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: 'f569148edd89ee041a4719ffc4733c16b05229bd',
      role: "switch",
      ...
      onBlur: this.onBlur,
      class: (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__.c)(color, {
        [mode]: true,
        'in-item': (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_7__.h)('ion-item', el),
      ...
      key: '3027f2ac4be6de422a14486d847fbee77f615db1',
      class: "toggle-wrapper",
      htmlFor: inputId
    }, (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", Object.assign({
      key: '4b0304c9e879e432b80184b4e5de37d55c11b436',
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      checked: checked,
      ...
      key: '8ef265ec942e7f01ff31cbb202ed146c6bf94e02',
      class: {
      ...
      key: '7b162b7dd27199cca2a4c995276a18b9f8e44aaf'
    }), this.renderHintText()), (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'd13c34bd42fca01cc73ddb4ea7e471b33a282a3e',
