...
/* harmony import */ var _validity_DJztqcrH_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./validity-DJztqcrH.js */ 9755);
...
const Radio = class {
  ...
  connectedCallback() {
    ...
    if (radioGroup) {
      this.updateState();
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.f)(radioGroup, 'ionValueChange', this.updateState);
    }
  }
  disconnectedCallback() {
    const radioGroup = this.radioGroup;
    if (radioGroup) {
      (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.m)(radioGroup, 'ionValueChange', this.updateState);
      this.radioGroup = null;
    }
  }
  get hasLabel() {
...
const RadioGroup = class {
  ...
  connectedCallback() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (typeof MutationObserver !== 'undefined') {
        _this3.validationObserver = new MutationObserver(() => {
          const newIsInvalid = (0,_validity_DJztqcrH_js__WEBPACK_IMPORTED_MODULE_6__.c)(_this3.el);
          if (_this3.isInvalid !== newIsInvalid) {
            _this3.isInvalid = newIsInvalid;
            /**
            ...
            Promise.resolve().then(() => {
              _this3.hintTextId = _this3.getHintTextId();
            });
          }
        });
        _this3.validationObserver.observe(_this3.el, {
          attributes: true,
          attributeFilter: ['class']
        });
      }
      // Always set initial state
      _this3.isInvalid = (0,_validity_DJztqcrH_js__WEBPACK_IMPORTED_MODULE_6__.c)(_this3.el);
    })();
  }
  componentWillLoad() {
  ...
  render() {
    ...
    const mode = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_5__.b)(this);
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.a)(true, el, name, value, false);
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      key: 'db593b3ed511e9395e3c7bfd91b787328692cd6d',
      role: "radiogroup",
      ...
      key: '85045b45a0100a45f3b9a35d1c5a25ec63d525c4',
      class: "radio-group-wrapper"
    }, (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      key: '53dacb87ce62398e78771fb2efaf839ab922d946'
    })));
  }
  get el() {
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.g)(this);
