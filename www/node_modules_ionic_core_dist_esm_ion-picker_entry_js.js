...
const Picker = class {
  constructor(hostRef) {
    ...
    this.ionInputModeChange = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionInputModeChange", 7);
  ...
  componentWillLoad() {
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  /**
   * @internal
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_ion-picker_entry_js.js.map