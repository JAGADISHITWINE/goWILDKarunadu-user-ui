...
/* harmony import */ var _config_mCdtaoPe_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./config-mCdtaoPe.js */ 3550);
...
/* harmony import */ var _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-D5YkFThA.js */ 9402);
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 247);
/* harmony import */ var _ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ionic-global-CDrldh-5.js */ 7854);
/* harmony import */ var _animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./animation-Dt8bGnA-.js */ 5846);
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 575);
/* harmony import */ var _index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-CfgBF1SE.js */ 5860);
...
/* harmony import */ var _framework_delegate_BYawdMXj_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./framework-delegate-BYawdMXj.js */ 5311);
...
function getAnimationPosition(position, positionAnchor, mode, toast) {
   ...
   */
  if (positionAnchor && _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_9__.w) {
    ...
    if (position === 'top') {
       ...
       */
      offset -= _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_9__.w.innerHeight - box.top;
    }
    /**
...
function warnIfAnchorIsHidden(positionAnchor, toast) {
  if (positionAnchor.offsetParent === null) {
    (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - The positionAnchor element for ion-toast was found in the DOM, but appears to be hidden. This may lead to unexpected positioning of the toast.', toast);
  }
}
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  const baseAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_8__.c)();
  const wrapperAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_8__.c)();
  const {
    position,
    top,
    bottom
  } = opts;
  const root = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.g)(baseEl);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
   ...
   */
  const wrapperEl = (0,_helpers_DEn3pfjm_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector('.toast-wrapper');
  ...
  const swipeAnimation = (0,_animation_Dt8bGnA_js__WEBPACK_IMPORTED_MODULE_8__.c)('toast-swipe-to-dismiss-animation').addElement(wrapperEl)
  /**
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_10__.createGesture)({
    el: wrapperEl,
    gestureName: 'toast-swipe-to-dismiss',
    gesturePriority: _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.O,
    /**
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastDidDismiss", 7);
    ...
    this.delegateController = (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.d)(this);
    this.lockController = (0,_lock_controller_B_hirT0v_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    this.triggerController = (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.e)();
    this.customHTMLEnabled = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.get('innerHTMLTemplatesEnabled', _config_mCdtaoPe_js__WEBPACK_IMPORTED_MODULE_2__.E);
     ...
     */
    this.duration = _index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.e.getNumber('toastDuration', 0);
    /**
    ...
    this.dispatchCancelHandler = ev => {
      ...
      if ((0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.i)(role)) {
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.G);
      });
      gesture.enable(true);
    };
    /**
  ...
  connectedCallback() {
    (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.j)(this.el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
  ...
  present() {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationPosition = getAnimationPosition(position, anchor, (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_7__.b)(_this), el);
      /**
      ...
      yield (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
   ...
   */
  onDidDismiss() {
    return (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  getAnchorElement() {
    ...
    if (position === 'middle' && positionAnchor !== undefined) {
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - The positionAnchor property is ignored when using position="middle".', this.el);
      return undefined;
    }
    if (typeof positionAnchor === 'string') {
      ...
      if (foundEl === null) {
        (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-toast] - An anchor element with an ID of "${positionAnchor}" was not found in the DOM.`, el);
        return undefined;
      }
      return foundEl;
    }
    ...
    (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - Invalid positionAnchor value:', positionAnchor, el);
    return undefined;
  }
  buttonClick(button) {
    var _this3 = this;
  ...
  callButtonHandler(button) {
    return (0,_var_www_html_goWILDKarunadu_goWILDKarunadu_user_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.s)(button.handler);
          if (rtn === false) {
            // if the return value of the handler is false then do not dismiss
            return false;
          }
        } catch (e) {
          (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-toast] - Exception in callButtonHandler:', e);
        }
      }
      return true;
    })();
  ...
  renderButtons(buttons, side) {
    ...
    const mode = (0,_ionic_global_CDrldh_5_js__WEBPACK_IMPORTED_MODULE_7__.b)(this);
    ...
    }, buttons.map(b => (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }, b.icon && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      "aria-hidden": "true",
      icon: b.icon,
      slot: b.text === undefined ? 'icon-only' : undefined,
      class: "toast-button-icon"
    }), b.text), mode === 'md' && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  renderToastMessage(key, ariaHidden = null) {
    ...
    if (customHTMLEnabled) {
      return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
        ...
        class: "toast-message",
        part: "message",
        innerHTML: (0,_config_mCdtaoPe_js__WEBPACK_IMPORTED_MODULE_2__.a)(message)
      });
    }
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: key,
  ...
  render() {
    ...
    if (layout === 'stacked' && startButtons.length > 0 && endButtons.length > 0) {
      (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - This toast is using start and end buttons with the stacked toast layout. We recommend following the best practice of using either start or end buttons with the stacked toast layout.', el);
    }
    return (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_C8IsBmNU_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
...
const buttonPart = button => {
  return (0,_overlays_D5YkFThA_js__WEBPACK_IMPORTED_MODULE_5__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
  ios: toastIosCss,
  md: toastMdCss
