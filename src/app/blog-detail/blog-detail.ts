...
export class BlogDetail {
  ...
  getRelatedPosts(categoryId: string | number, excludePostId: string | number): Observable<any> {
  ...
  likeComment(commentId: string | number): Observable<any> {
  ...
  updateComment(commentId: string | number, userId: string | number, content: string): Observable<any> {
  ...
  deleteComment(commentId: string | number, userId: string | number): Observable<any> {
